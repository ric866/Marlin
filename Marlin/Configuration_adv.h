...
// Re-map Pins to make sure we know what is what
#define FAN2_PIN              -1  // Unmap fan 2 from PE6
#define SPINDLE_LASER_PWM_PIN PC9 // Hardware PWM laser TTL input
#define SPINDLE_LASER_ENA_PIN PE6 // CO2 PSU enable input
